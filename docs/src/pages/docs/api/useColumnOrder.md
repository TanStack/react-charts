...
- [Source](https://github.com/tannerlinsley/react-charts/tree/next/examples/column-ordering)
- [Open in CodeSandbox](https://codesandbox.io/s/github/tannerlinsley/react-charts/tree/next/examples/column-ordering)
