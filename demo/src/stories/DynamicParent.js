...
class Story extends Component {
  ...
  render () {
    ...
    return (
      <div>
        <p>
          Charts should take on the dimensions of their parent, and should not have a min/max width
          or height. Padding, margin and borders should not throw off this dynamic calculation of
          size either. The example below uses all of these properties, including being a flex child
          with grow capabilities.
        </p>
        <button
          onClick={() =>
            this.setState({
