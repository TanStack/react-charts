...
const sidebarItems = [
  { title: 'Line Chart', path: 'line', component: require('containers/LineChart').default },
  { title: 'Bubble Chart', path: 'bubble', component: require('containers/BubbleChart').default },
  { title: 'Area Chart', path: 'area', component: require('containers/AreaChart').default },
  { title: 'Bar Chart', path: 'bar', component: require('containers/BarChart').default },
  { title: 'Column Chart', path: 'column', component: require('containers/ColumnChart').default },
  {
    title: 'Axis Options',
    path: 'axis-options',
  ...
  { title: 'Cursors', path: 'cursors', component: require('containers/Cursors').default },
  {
    title: 'Synced Cursors',
    path: 'synced-cursors',
    component: require('containers/SyncedCursors').default,
  },
  { title: 'Brushing', path: 'brushing', component: require('containers/Brushing').default },
  {
  ...
  },
  {
    ...
    path: 'tooltip-anchor',
    component: require('containers/TooltipAnchor').default,
  },
  {
  ...
  { title: 'Sparklines', path: 'sparkline', component: require('containers/Sparklines').default },
  {
    title: 'Mixed Types',
  ...
  { title: 'Dark Mode', path: 'dark', component: require('containers/DarkMode').default },
  {
    title: 'Stress Test',
    path: 'stress-test',
